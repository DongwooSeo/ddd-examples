...
/**
 * 쿠폰 포트의 HTTP 어댑터 (Anti-Corruption Layer)
 *
 * DDD / 헥사고날 아키텍처:
 * - {@link CouponPort} 아웃바운드 포트의 구현체(어댑터)
 * - 외부 Bounded Context(쿠폰 도메인)와의 HTTP 통신을 담당
...
@Slf4j
@Component
public class CouponHttpClient implements CouponPort {
